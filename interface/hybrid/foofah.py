...
def main():
    ...
    #### llm take over when foofah fails to provide a solution
    #######
    SERVER_URL = "http://container1:5050/get_output" 
    ...
    for test_file in test_files:
        ...
        if final_node:
            ...
            if response.status_code == 200:
                ...
                test_data["TransformedTestTable"] = response_data["response"]
                test_data["Success"] = True
                print("Chat Response:", response_data["response"])
            else:
        ...
        if not llm:
            ...
            filename = dirname + "/exp0_results_llm_" + str(test_data['TestName']) + "_" + str(
                test_data['NumSamples']) + ".txt"
